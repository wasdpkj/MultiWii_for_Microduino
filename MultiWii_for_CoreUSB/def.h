...
/**************************  atmega32u4 (Promicro)  ***********************************/
#if defined(PROMICRO)
  #if !defined(TEENSY20)
    #define LEDPIN_PINMODE             DDRB |= (1<<1);            //D13 to output
    #define LEDPIN_TOGGLE              PINB |= 1<<1;     //switch LEDPIN state (Port D13)
  ...
  #if defined(D10BUZZER)
    #define BUZZERPIN_PINMODE          DDRB |= (1<<0);
    #if defined PILOTLAMP
      #define    PL_PIN_ON            PORTB |= 1<<0;
      #define    PL_PIN_OFF           PORTB &= ~(1<<0);
    #else
      #define BUZZERPIN_ON               PORTB |= 1<<0;
      #define BUZZERPIN_OFF              PORTB &= ~(1<<0); 
    #endif 
  ...
  //soft PWM Pins  
  #define SOFT_PWM_1_PIN_HIGH        PORTC |= 1<<6;       //d5
  #define SOFT_PWM_1_PIN_LOW         PORTC &= ~(1<<6);
  #define SOFT_PWM_2_PIN_HIGH        PORTD |= 1<<7;       //d4
  #define SOFT_PWM_2_PIN_LOW         PORTD &= ~(1<<7);
  #define SOFT_PWM_3_PIN_HIGH        PORTF |= 1<<5;
  #define SOFT_PWM_3_PIN_LOW         PORTF &= ~(1<<5);
  #define SOFT_PWM_4_PIN_HIGH        PORTF |= 1<<4;
  #define SOFT_PWM_4_PIN_LOW         PORTF &= ~(1<<4); 
  #define SW_PWM_P3                  A2        
  #define SW_PWM_P4                  A3 
  
  // Servos
  #define SERVO_1_PINMODE   DDRF |= (1<<5); // A2
  #define SERVO_1_PIN_HIGH  PORTF|= 1<<5;
  #define SERVO_1_PIN_LOW   PORTF &= ~(1<<5);
  #define SERVO_2_PINMODE   DDRF |= (1<<4); // A3
  #define SERVO_2_PIN_HIGH  PORTF |= 1<<4;
  #define SERVO_2_PIN_LOW   PORTF &= ~(1<<4);
  #define SERVO_3_PINMODE   DDRD |= (1<<7); // 4
  #define SERVO_3_PIN_HIGH  PORTD |= 1<<7;
  #define SERVO_3_PIN_LOW   PORTD &= ~(1<<7);

  #define SERVO_4_PINMODE   DDRC |= (1<<6); // 5
  #define SERVO_4_PIN_HIGH  PORTC |= 1<<6;
  #define SERVO_4_PIN_LOW   PORT6 &= ~(1<<6);
  #define SERVO_5_PINMODE   DDRB |= (1<<7); // 7
  #define SERVO_5_PIN_HIGH  PORTB|= 1<<7;
  #define SERVO_5_PIN_LOW   PORTB &= ~(1<<7);
  #define SERVO_6_PINMODE   DDRC |= (1<<7); // 6
  #define SERVO_6_PIN_HIGH  PORTC |= 1<<7;
  #define SERVO_6_PIN_LOW   PORTC &= ~(1<<7);
  #define SERVO_7_PINMODE   DDRB |= (1<<6); // 8
